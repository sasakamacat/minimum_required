...
mkdir -p ~/training/sft_Qwen3-32B_deepmath_0811
mkdir -p ~/training/sft_Qwen3-32B_deepmath_0811
mkdir -p ~/training/sft_Qwen3-32B_deepmath_0811/checkpoints

cd ~/training/sft_Qwen3-32B_deepmath_0811
...
export WANDB_RUN_NAME="Qwen3-32B_deepmath_0811"
...
torchrun --standalone --nnodes=1 --nproc_per_node=4 \
  ...
  trainer.experiment_name=$WANDB_RUN_NAME | tee ~/training/sft_Qwen3-32B_deepmath_0811/verl_sft.log


cd $HOME/model/sft_Qwen3-32B_deepmath_0811/checkpoints
ls -la
...
LATEST_CHECKPOINT=$(find $HOME/training/sft_Qwen3-32B_deepmath_0811/checkpoints -name "global_step_*" -type d | sort -V | tail -1)
